...
// demo encryption
function demo_aead(){
    var demo_encrypt = "=== demo encryption using Ascon-128 ===";
    var key = "eaa9119aa3a9bd5e50bccda4e13d1c03";
    var nonce = "1a6527a36645ddb9490671dc5d1e1ebb";
    var associateddata = "Ascon in javascript"; 
    var plaintext = "javascript is not easy";
    var ciphertext = ascon_encrypt(key, nonce, associateddata, plaintext);
    var tag = ciphertext.slice(-32);
    var recievedplaintext = ascon_decrypt(key, nonce, associateddata, ciphertext);
    var verification = "failed";

    if(recievedplaintext != null){
        verification = "succeeded!";
    }

    return `${demo_encrypt}\nassociateddata: ${associateddata}\nplaintext: ${plaintext}\nkey: 0x${key}\nnonce: 0x${nonce}\nciphertext: 0x${ciphertext.slice(0, -32)}\ntag: 0x${tag}\nrecievedplaintext: ${recievedplaintext}\nverification: ${verification}`;
}

// main program
console.log(demo_aead());
